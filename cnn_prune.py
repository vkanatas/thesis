...
from models.cnn_network import *
...
if __name__ == '__main__':
    ...
    if not os.path.isdir(f"./{dataset}_{appliance}"):
        ...
        dissagregator = CNNDissagregator(appliance, dataset, 5, 256)
        trained_model = tf.keras.models.load_model(
            f'{dataset}/saved_model/cnn_seq2seq/model_appliance_{appliance}')
        ...
        predicted_output_sequence = dissagregator.predict(X_test, Y_test, type_model='pruned')
        ...
        dissagregator.compute_metrics(predicted_output_sequence, Y_test, state_test)
        print('*************************')
