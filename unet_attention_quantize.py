...
if __name__ == '__main__':
    ...
    if not os.path.isdir(f"./{dataset}_{appliance}"):
        ...
        dissagregator = UnetAttentionDissagregator(appliance, dataset, 1, 256)


        pruned_model = tf.keras.models.load_model(f'./{dataset}/saved_pruned_model/attention_unet/model_appliance_{appliance}_percentage_{percentage}')
