...
if __name__ == '__main__':
    ...
    if not os.path.isdir(f"./{dataset}_{appliance}"):
        ...
        dissagregator = AttentionTCNDissagregator(appliance, dataset, 5, 256)
        trained_model = tf.keras.models.load_model(
            f'{dataset}/saved_model/attention_tcn/model_appliance_{appliance}')
        ...
        mae, f1 = dissagregator.compute_metrics(predicted_output_sequence, Y_test, predicted_output_sequence_onoff,
                                                state_test)
